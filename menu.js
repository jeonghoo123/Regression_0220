...
menu1.url = "?menu=1"
menu1.tips = ["2.1 ㅇㅅ","2.2 ㅇㅅ","2.3 ㅇㅅ"] //로그인 로그아웃 기능
menu2 = new Menu("3. ㅇㅅㅁㄴ")
menu2.url = "?menu=2"
menu2.tips = ["3.1 ㅇㅅ","3.2 ㅇㅅ","3.3 ㅇㅅ","3.4 ㅇㅅ "]
menu3 = new Menu("4. ㅇㅅ")
menu3.url = "?menu=3"
menu3.tips = ["4.1 ㅇㅅ"]// (5분마다 프로그램 정상 작동유무 출력 메시지 스케줄링 확인)
